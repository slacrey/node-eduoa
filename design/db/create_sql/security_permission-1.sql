...
INSERT INTO 'security_permission'('id', 'description', 'name', 'short_name', 'module_id')
  VALUES(235, NULL, '增', 'save', 79);
INSERT INTO 'security_permission'('id', 'description', 'name', 'short_name', 'module_id')
  VALUES(236, NULL, '删', 'delete', 79);
INSERT INTO 'security_permission'('id', 'description', 'name', 'short_name', 'module_id')
  VALUES(237, NULL, '查', 'view', 79);
INSERT INTO 'security_permission'('id', 'description', 'name', 'short_name', 'module_id')
  VALUES(238, NULL, '改', 'edit', 79);
INSERT INTO 'security_permission'('id', 'description', 'name', 'short_name', 'module_id')
  VALUES(239, NULL, '查', 'view', 80);
INSERT INTO 'security_permission'('id', 'description', 'name', 'short_name', 'module_id')
  VALUES(244, '', '通过', 'pass', 82);
INSERT INTO 'security_permission'('id', 'description', 'name', 'short_name', 'module_id')
  VALUES(245, '', '驳回', 'reject', 82);
INSERT INTO 'security_permission'('id', 'description', 'name', 'short_name', 'module_id')
  VALUES(246, '', '查看', 'view', 82);
INSERT INTO 'security_permission'('id', 'description', 'name', 'short_name', 'module_id')
  VALUES(247, NULL, '查', 'view', 83);
INSERT INTO 'security_permission'('id', 'description', 'name', 'short_name', 'module_id')
  VALUES(248, '', '销假', 'sick', 80);
