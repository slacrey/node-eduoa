...
<div class="pageContent">
	...
	<div class="panelBar">
		<ul class="toolBar">
			<shiro:hasPermission name="TeachingPlan:look">
				<li><a class="magnifier" target="dialog" mask="true" width="530" height="350" href="${contextPath }/management/eduoa/teachingplan/view/{slt_uid}"><span>查看课件</span></a></li>
			</shiro:hasPermission>		
