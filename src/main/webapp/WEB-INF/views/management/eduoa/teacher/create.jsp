...
<div class="pageContent">
    <form method="post" action="${contextPath }/management/eduoa/position/create"
        ...
        <div class="pageFormContent" layoutH="56">
            ...
            <p>
                <label>员工序号：</label>
                <input name="teacherNumber" type="text" size="30" value="100001" readonly="readonly"/>
            </p>

            <p>
                <label>姓名：</label>
                <input name="teacherName" class="required" type="text" size="30" value="张慧华" alt="请输入客户名称"/>
            </p>
